...
const Home = () => {
    ...
    return (
        ...
        <div className="container">
            <div className="col"> <div className="image"><Link to="/thirdpost"><img src="./img/2222.jpg" alt="" /></Link> </div>
                <div className="name">
                         
                    <h1><Link className='perehod' to="/thirdpost" >Один из сказок</Link></h1>
            ...
            <div className="col">
                <div className="image"><Link to="/thirdpost"><img src="./img/3333.jpg" alt="" /></Link></div> <div className="name">
                <h1><Link className='perehod' to="/thirdpost" >Один из сказок</Link></h1>
                <button onClick={handleBuyClick} className="buy-button">Купить</button>
            ...
            <div className="col"> <div className="image"><Link to="/thirdpost"><img src="./img/4444.webp" alt="" /></Link></div> <div className="name">
            <h1><Link className='perehod' to="/thirdpost" >Один из сказок</Link></h1>
            ...
            <div className="col"> <div className="image"><Link to="/thirdpost"><img src="./img/5555.jpg" alt="" /></Link></div> <div className="name">
            <h1><Link className='perehod' to="/thirdpost" >Один из сказок</Link></h1>
                <b className="price">$0</b>
                <br />
            </div><h6>15 Reviews</h6>
            ...
            <div className="col"> <div className="image"><Link to="/thirdpost"><img src="./img/6666.jpg" alt="" /></Link></div> <div className="name">
            <h1><Link className='perehod' to="/thirdpost" >Один из сказок</Link></h1>
                <b className="price">$0</b>
                <br />
            </div><h6>15 Reviews</h6>
            ...
            <div className="col"> <div className="image"><Link to="/thirdpost"><img src="./img/7777.jpg" alt="" /></Link></div> <div className="name">
            <h1><Link className='perehod' to="/thirdpost" >Один из сказок</Link></h1>
                <b className="price">$0</b>
                <br />
            </div><h6>15 Reviews</h6>
